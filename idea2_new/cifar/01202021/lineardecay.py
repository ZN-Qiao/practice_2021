# resnet50_StoDepth_lineardecay(pretrained=True, prob_0_L=[1.0, 0.8])
...
class StoDepth_BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.downsample is not None:
            ...
            # self.prob = 1.0  ### to check check its influence

        out = self.prob * out + (1 - self.prob) * out.data
...
def resnet50_StoDepth_lineardecay(pretrained=False, prob_0_L=[1, 0.5], **kwargs):
