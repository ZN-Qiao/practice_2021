...
class BasicBlock(nn.Module):
    ...
    def __init__(self, weight, inplanes, planes, stride=1, downsample=None):
    ...
    def forward(self, x):
        ...
        # self.weight = 0.5  # backward weight for training the network (0.9 for instace, in practice, we can change it based on needs)
...
def demo():
    net = resnet50(num_classes=10, weight=0.8)
    net.update_weight(60)
